import { ForwardedRef, PropsWithChildren, SVGProps, forwardRef } from 'react'
...
const Logo = (props: SVGProps<SVGSVGElement>): JSX.Element => {
  return (
    ...
    //   />
    // </svg>
    <Image src="/images/LogoDark.svg" alt="logo mobile" width={79} height={24}/>
  )
}
...
AppScreen.Header = forwardRef(function AppScreenHeader({
  children
}: { children: React.ReactNode }, ref: ForwardedRef<HTMLDivElement>) {
  return (
