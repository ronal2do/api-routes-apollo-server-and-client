...
export function TupleLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function TransistorLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
...
export function DiageoLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="#fff"
...
export function StaticKitLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
...
export function StatamicLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function MirageLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 40 40" fill="#fff" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export function ReversableLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="none"
