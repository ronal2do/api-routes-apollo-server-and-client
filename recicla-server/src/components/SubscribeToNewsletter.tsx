...
export interface SubscripbeToNewsletterInput {
  email: string
}

interface ISubscribeToNewsletterProps {
}

export const SubscribeToNewsletter: React.FunctionComponent<ISubscribeToNewsletterProps> = (props) => {
  const [inputEmail, setInputEmail] = useState('')
  const [createNewsletterEntry, { data, loading, error }] = useMutation<ISubscribeToNewsletter, SubscripbeToNewsletterInput>(
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      if (data?.createNewsletterEntry.error) {
        toast({
