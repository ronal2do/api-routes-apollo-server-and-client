                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {data && data.newsletters?.edges?.map((edge) => (
                    <tr key={edge.node.email}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{edge.node.title}</td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{edge.node.email}</td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{edge.node.role}</td>
