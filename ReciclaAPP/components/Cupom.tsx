...
export default class Cupom extends PureComponent<CupomProps> {
  render() {
          ...
          <G >
            <G >
              ...
              <G fill="none" stroke="#fff" strokeMiterlimit={10}>
                ...
                />
                <Path d="M195.275 14.752l.064 95.889" />
              </G>
            </G>
            <Text
              transform="translate(44 50.834)"
              fill="#fff"
              fontSize="12"
